...
public class MainActivity extends AppCompatActivity {
    ...
    private void processViews() {
        ...
        {
            addSingleRowToTable(m_StuList.get(i));
        }
    }

    private void addSingleRowToTable(StudentProfile stuPro) {
        ...
        for( int j = 0; j < nTableCol ; j++ )
        {
            ...
            int marginInDpBottom = marginInDp*2;
            ...
            if(j == 0) tv.setText(String.valueOf(stuPro.m_nID));
            else if(j == 1) tv.setText(stuPro.m_stdName);
            else if(j == 2) tv.setText(stuPro.m_strSex);
            else tv.setText(String.valueOf(stuPro.m_nScore));
